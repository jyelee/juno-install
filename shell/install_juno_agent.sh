...
Install_Juno_Agent()
{
    ...
    mv /home/www/server/juno-agent/* ${APP_PATH_BIN}


    #wget -P ${DOWNLOAD_PATH} https://github.com/douyu/juno-agent/archive/refs/tags/v${JUNO_AGENT_VER}.tar.gz
    tar xvf ${DOWNLOAD_PATH}/juno-agent-${JUNO_AGENT_VER}.tar.gz -C ${APP_PATH}
...
ExecStart=/home/www/server/juno-agent/bin/juno-agent  --host 0.0.0.0 --config=/home/www/server/juno-agent/config/config.toml
